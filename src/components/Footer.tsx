      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-4 mb-5 mb-lg-0">
            <h4 className="text-uppercase mb-4 custom-footer">Contact</h4>
          ...
          <div className="col-lg-4 mb-5 mb-lg-0">
            <h4 className="text-uppercase mb-4 custom-footer">Around the Web</h4>
          ...
          <div className="col-lg-4">
            <h4 className="text-uppercase mb-4 custom-footer">Third Category</h4>
            <p className="lead mb-0">
